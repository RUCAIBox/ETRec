...
from recbole.model.transformer_layers import HaloNetEncoder


class HaloNet(SequentialRecommender):

    def __init__(self, config, dataset):
        super(HaloNet, self).__init__(config, dataset)
        ...
        self.trm_encoder = HaloNetEncoder(n_layers=self.n_layers,
